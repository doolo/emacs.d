...
* font size
#+BEGIN_SRC emacs-lisp
  (use-package default-text-scale  ; https://github.com/purcell/default-text-scale
    :ensure t
    :init
    (progn  ; progn is used when mutilple lines of code need executing;;
      (default-text-scale-mode t)  ;; enable mode by default
      )
  )
...
* org mode
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; use python3 as code block interpreter
    (setq orgf-babel-python-command "python3")
...
* Flyspell
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    ;; Disable flyspell for log-edit-mode and change-log-mode
    ;; (dolist (hook '(change-log-mode-hook log-edit-mode-hook))
    ;;      (add-hook hook (lambda () (flyspell-mode -1))))

    ;; spellcheck against comments
    (flyspell-prog-mode)
  #+END_SRC
* Yasnippet
#+BEGIN_SRC emacs-lisp
...
* Python
  #+BEGIN_SRC emacs-lisp
    ...
    ;; install epc and virtualenv:
    ;; sudo pip install epc virtualenv
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Disable git-gutter for now since the moving window bug
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;   (custom-set-variables
  ;;    ;; below is the dir of eclipse
  ;;   '(eclim-eclipse-dirs '("~/program/java/eclipse/eclipse"))
  ;;    ;; below is the path of eclim executable
  ...
  ;;   ;; this should have been configured in autocomplete section
